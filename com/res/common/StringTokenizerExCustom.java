 ...
 */
public class StringTokenizerExCustom implements Iterator<String>, Enumeration<String>, Iterable<String>
{
	...
	public StringTokenizerExCustom(final String aStringToSplit)
	{
	...
	public void match(final String aStringToSplit)
	{
		this.values = new String[] {};
		this.stringToSplit = aStringToSplit;
		if(this.regexp==null) this.regexp = DEFAULT_REGEXP;
		split();
	}
	 ...
	 */
	public StringTokenizerExCustom(final String aStringToSplit, final String aRegExp)
	{
		this.stringToSplit = aStringToSplit;
		this.regexp = aRegExp;
		split();
